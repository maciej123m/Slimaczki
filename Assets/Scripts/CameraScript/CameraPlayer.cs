...
public class CameraPlayer : MonoBehaviour {
    ...
    private bool aimingKeyPress = false;
    ...
    public void UnLoadPlayerFromCameraObject() {
        SwitchCamera(false);
        playerRidigbodyScript.IsMove(false);
        player = null;
    }
    ...
    private void SwitchCamera() {
        if (!cameraLocked) {
            aimingKeyPress = !aimingKeyPress;
        }
        else {
            aimingKeyPress = false;
        }
    ...
    /// <summary>
    /// tylko podczas unload!
    /// </summary>
    /// <param name="tryb"></param>
    private void SwitchCamera(bool tryb) {
        aimingKeyPress = tryb;
        // rotX = celownik.transform.parent.eulerAngles.x;
        // rotY = celownik.transform.parent.eulerAngles.y;
        endAiminng = false;
    ...
    public void LockCamera() {
        StartCoroutine(LockCameraCoroutine());
    }
